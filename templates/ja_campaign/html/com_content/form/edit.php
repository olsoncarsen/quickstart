...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_content&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		<fieldset>
			...
			<?php echo JHtml::_('bootstrap.addTab', $this->tab_name, 'editor', JText::_('COM_CONTENT_ARTICLE_CONTENT_OVERRIDE')); ?>
			...
			<div class="custom-edit-content">
				...
				<div class="control-label">
					<label id="jform_intro_text-lbl" for="jform_intro_text"><?php echo JText::_('COM_CONTENT_ARTICLE_INTRO_TEXT');?></label>
				</div>
				<!-- Intro text -->
